...
var (
	...
	ErrUpdatePostFailed        = xerror.NewError(30005, "动态更新失败")
	ErrLockPostFailed          = xerror.NewError(30006, "动态锁定失败")
	ErrGetPostTagsFailed       = xerror.NewError(30007, "获取话题列表失败")
	ErrInvalidDownloadReq      = xerror.NewError(30008, "附件下载请求不合法")
	ErrDownloadReqError        = xerror.NewError(30009, "附件下载请求失败")
	ErrInsuffientDownloadMoney = xerror.NewError(30010, "附件下载失败:账户资金不足")
